...
exports.DEFAULT_POINTS_CONFIG = exports.PRESET_T20 = exports.PRESET_TEST = void 0;
...
exports.DEFAULT_POINTS_CONFIG = exports.PRESET_T20;
function calculatePoints(result, side, config) {
    if (config === void 0) { config = exports.DEFAULT_POINTS_CONFIG; }
    switch (result) {
        case 'TIE':
            return config.tie;
        case 'NO_RESULT':
