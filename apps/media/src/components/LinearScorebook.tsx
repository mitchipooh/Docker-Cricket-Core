...
import { InningsStats } from '@cricket/shared';
import { BowlingCardRow, BattingCardRow } from '@cricket/shared/scoring/scorecard/scorecard/types';
            ...
            <div className="w-full overflow-x-auto">
               <div className="w-full overflow-x-auto">
                  ...
                  <div className="flex border-b border-slate-300 bg-slate-100">
                     ...
                     <div className="flex-1 flex" style={{ minWidth: '768px' }}>
                  ...
                  {bowlingRows.map(bowler => (
                     <div key={bowler.playerId} className="flex border-b border-slate-300 h-14">
                        ...
                        {/* The Over Boxes */}
                        <div className="flex-1 flex bg-white overflow-hidden" style={{ minWidth: '768px' }}>
