...
exports.BowlingScorecard = void 0;
var react_1 = require("react");
var BowlingScorecard = function (_a) {
    var rows = _a.rows;
    return (<div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-xl w-full">
      <div className="overflow-x-auto no-scrollbar">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-slate-800/50">
            {rows.map(function (r) { return (<tr key={r.playerId} className="group hover:bg-white/5 transition-colors">
...
exports.BowlingScorecard = BowlingScorecard;
