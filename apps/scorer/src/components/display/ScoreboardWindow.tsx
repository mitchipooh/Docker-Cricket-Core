...
import { MatchState, Team, Sponsor, SponsorSettings } from '@cricket/shared';
import { getBattingStats, getBowlingStats } from '@cricket/shared/scoring/MatchSelectors';
import { useBallTimeline } from '@cricket/shared/scoring/hooks/useBallTimeline';
...
export const ScoreboardWindow: React.FC = () => {
    ...
    const { state, teams, sponsors, sponsorSettings: settings } = data;
