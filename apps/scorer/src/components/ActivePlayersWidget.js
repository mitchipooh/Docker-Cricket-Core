...
exports.ActivePlayersWidget = void 0;
var react_1 = require("react");
var ActivePlayersWidget = function (_a) {
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
            {/* Batsmen */}
...
exports.ActivePlayersWidget = ActivePlayersWidget;
