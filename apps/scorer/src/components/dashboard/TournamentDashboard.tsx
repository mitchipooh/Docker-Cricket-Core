...
import { BracketView } from '@cricket/shared/competition/BracketView';
...
import { PointsConfigSettings } from '../admin/PointsConfigSettings';
import { MatchResultEntryForm } from '../admin/MatchResultEntryForm';
