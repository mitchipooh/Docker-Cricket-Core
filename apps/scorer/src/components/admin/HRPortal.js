...
exports.HRPortal = void 0;
var react_1 = require("react");
var HRPortal = function (_a) {
    var scorers = _a.scorers;
    return (<div className="space-y-8 animate-in fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            var _a, _b, _c;
            return (<div key={scorer.id} className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-xl flex flex-col hover:border-indigo-300 transition-all group">
                    ...
                    <div className="flex-1 space-y-4 mb-6">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                ...
                                <div className="text-xl font-black text-slate-900">${((_a = scorer.scorerDetails) === null || _a === void 0 ? void 0 : _a.hourlyRate) || 'Neg'}/hr</div>
                            </div>
                            <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Exp</div>
                                <div className="text-xl font-black text-slate-900">{((_b = scorer.scorerDetails) === null || _b === void 0 ? void 0 : _b.experienceYears) || 0} Yrs</div>
                            </div>
                        </div>
                        <p className="text-sm text-slate-600 leading-relaxed italic">
                            "{((_c = scorer.scorerDetails) === null || _c === void 0 ? void 0 : _c.bio) || 'No bio provided.'}"
                        </p>
                    </div>
            ...
            {scorers.length === 0 && (<div className="col-span-full py-20 text-center text-slate-400 text-xs font-bold uppercase tracking-widest">
                    No scorers currently available for hire.
                </div>)}
        </div>
    </div>);
};
exports.HRPortal = HRPortal;
