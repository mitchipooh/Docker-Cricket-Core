...
var AdminCenter = function (_a) {
    ...
    var handleGenerateFixtures = function () { if (!activeOrg || !activeTrn)
        return; var newFix = (activeTrn.groups || []).flatMap(function (g) { return (0, cricket_engine_1.generateRoundRobin)(g.teams, activeTrn.id, g.id); }); onUpdateOrgs(organizations.map(function (o) { return o.id === activeOrg.id ? __assign(__assign({}, o), { fixtures: __spreadArray(__spreadArray([], o.fixtures, true), newFix, true) }) : o; })); };
