...
var commentaryGenerator_1 = require("@cricket/shared/utils/commentaryGenerator");
var newsGenerator_1 = require("@cricket/shared/utils/newsGenerator");
...
var Scorer = function (_a) {
    ...
    var handleRun = function (runs) {
        ...
        if (audioCommentary.enabled) {
            ...
            var commentary = (0, commentaryGenerator_1.generateCommentary)({
                runs: runs,
                batter: striker_1,
                bowler: bowler
            });
            ...
            if (ballsAfter > 0 && ballsAfter % 6 === 0) {
                ...
                var endOfOverCommentary_1 = (0, commentaryGenerator_1.generateEndOfOverCommentary)({
    ...
    var handleMatchFinish = function () {
        ...
        // Generat AI News
        var news = (0, newsGenerator_1.generateMatchNews)(match, engine.state);
        onAddMediaPost(news);
