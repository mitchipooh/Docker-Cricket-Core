...
exports.DeleteOrgModal = void 0;
var react_1 = require("react");
var DeleteOrgModal = function (_a) {
    var organization = _a.organization, onConfirm = _a.onConfirm, onCancel = _a.onCancel;
    return (<div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
...
exports.DeleteOrgModal = DeleteOrgModal;
